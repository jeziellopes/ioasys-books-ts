...
export const booksResponseMock = {
  data: [
    {
      authors: ['Yango Moreira Filho', 'Norberto Santos'],
      title: 'A dolorem itaque',
    ...
    },
    {
      ...
      language: 'Inglês',
      isbn10: '8373692201',
      isbn13: '382-8373692201',
      publisher: 'Saraiva - Braga',
      published: 2020,
      id: '60171639faf5de22b804a04d',
    },
    {
      authors: ['Margarida Silva', 'Paulo Silva Filho', 'Sr. Sirineu Carvalho'],
      title: 'Amet',
      description:
